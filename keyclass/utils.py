...
class Parser:
    ...
    def __init__(
            self,
            config_file_path='/content/drive/MyDrive/CS598DLH_KeyClass_Reproduce/Final_Project/config_files/default_config.yml',
            default_config_file_path='/content/drive/MyDrive/CS598DLH_KeyClass_Reproduce/Final_Project/config_files/default_config.yml'):
